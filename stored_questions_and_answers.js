const storedAnswersAndQuestions = {'quizTitle': 'GernalLondonQuiz', 'quizArray': [
{index: 1, 
...
{index: 2, 
    questionString: "How many rivers run through london?", 
    questionType: "singleChoice",
...
{index: 3, 
    questionString: "Which of Londons public museums is the oldest?", 
    questionType: "singleChoice",
...
{index: 4, 
    questionString: "London has the oldest underground railway, also knowen as the Tube. But what was the first tube Line?", 
    questionType: "singleChoice",
    arrayOfAnswers: ["District line", "Metroplitan Line", "Central Line", "Victoria Line"], 
    AnswerIndex: 1, 
...
{index: 5, 
    questionString: "How many times has London held the Summar Olympic Games?", 
    questionType: "singleChoice",
...
{index: 6, 
    questionString: "St. Paul's Cathedral is an icon of London, when was it built between?", 
    questionType: "singleChoice",
...
{index: 7, 
    questionString: "The Thames Barrier was completed in the 1980s, but for what purpose?", 
    questionType: "singleChoice",
...
{index: 8, 
    questionString: "Until the 1980s, Fish and Chips were served in?", 
    questionType: "singleChoice",
...
{index: 9, 
    questionString: "How many Tube stations are there in operation (2023)?", 
    questionType: "singleChoice",
...
{index: 10, 
    questionString: "London has a lot of trees, so many infact that the United Nations has classified London as an forest. Do you know how many trees are in London?", 
    questionType: "singleChoice",
...
{index: 11, 
    questionString: "When Hitler invaded Europe, several displaced governments moved to London, which where they?", 
    questionType: "singleChoice",
    ...
    AnswerIndex: 1, 
    explanationToIncorrectAns: 'During World War 2, Poland, Norway, Belgium, France and Holland/Netherlands all had exiled governments in London'}, 
{index: 12, 
